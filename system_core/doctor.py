...
def detect_python_mode(root: Path) -> str:
    ...
    if (root / "._runtime" / "python.exe").exists():
        return "alternate-portable-runtime"
...
def main() -> int:
    ...
    print(color("======================================================================", "36;1"))
    print(color("AUDION OFFICE IMAGE OPTIMIZER PORTABLE - DOCTOR", "36;1"))
    print(color("======================================================================", "36;1"))
    ...
    info_row("Input", root / "input")
    info_row("Output", root / "output")
    info_row("GitHub docs", root / "GitHub")
    print()
    ...
    print()
    if failed:
        print(f"{status_label('FAIL')} [RESULT] One or more checks failed.")
        return 1

    print(f"{status_label('OK')} [RESULT] Required environment looks good.")
    return 0
