...
title Audion Office Image Optimizer Portable - Tools Launcher
...
set "TOOLS_PROMPT=audion@image-optimizer [TOOLS] > "
...
cls
echo ======================================================================
echo   AUDION OFFICE IMAGE OPTIMIZER PORTABLE - TOOLS / SERVICE / RELEASE
echo ======================================================================
...
>>"%MENU_FILE%" echo.
>>"%MENU_FILE%" echo [06] OPEN GitHub                          ^| open_github         ^| explorer
>>"%MENU_FILE%" echo [07] OPEN licenses                        ^| open_licenses       ^| explorer
>>"%MENU_FILE%" echo [08] OPEN release                         ^| open_release        ^| explorer
>>"%MENU_FILE%" echo [09] OPEN system_core                     ^| open_core           ^| explorer
>>"%MENU_FILE%" echo [10] OPEN install                         ^| open_install        ^| explorer
>>"%MENU_FILE%" echo [11] OPEN wheelhouse                      ^| open_wheels         ^| explorer
...
echo [6] Open GitHub
echo [7] Open licenses
echo [8] Open release
echo [9] Open system_core
echo [A] Open install
echo [B] Open wheelhouse
echo [0] Back
echo.
choice /C 123456789AB0 /N /M "Select: "
if errorlevel 12 exit /b 0
if errorlevel 11 goto OPEN_WHEELS
if errorlevel 10 goto OPEN_INSTALL
if errorlevel 9 goto OPEN_CORE
if errorlevel 8 goto OPEN_RELEASE
if errorlevel 7 goto OPEN_LICENSES
